...
public class ReadFileTest {
    ...
    public void testBrokenFile() throws Exception {
        String expected = (""+
                ...
                "Dense node, ID 691202854 @ 51.766818,-0.232419\n" +
                "Failure!\n").replace("\n", System.lineSeparator());
        test("/broken7000bytes.pbf", expected);
    }

    private static void test(String fileName, String expected) throws Exception {
        try (InputStream input = ReadFileTest.class.getResourceAsStream(fileName);
